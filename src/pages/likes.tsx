import { useGetUserLikedRemastersInfinite } from "@/api/remaster-controller/remaster-controller";
...
const Likes: NextPage = ({}) => {
  ...
  const {
    ...
    isLoading,
    fetchNextPage,
  } = useGetUserLikedRemastersInfinite(
  ...
  return (
    <>
      <Head>
        <title>Remaster - Likes</title>
      </Head>
      <main className="flex flex-1 flex-col gap-2">
        <Marquee>Your Likes</Marquee>
